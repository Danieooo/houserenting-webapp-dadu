...
## 0. Tình trạng tài liệu hiện tại

- `README.md` chưa được viết đầy đủ trước đây, nay đã cập nhật với tổng quan dự án và đường dẫn tới tài liệu.
...
- **Quản lý Hóa đơn:**
  ...
  - **Xuất PDF:** Tạo hóa đơn PDF rõ ràng, chuyên nghiệp. Hỗ trợ in đầy đủ tiếng Việt khi có font Unicode, và hiển thị mã QR chuyển khoản tự động nếu thông tin thanh toán đã được cấu hình trong cài đặt.
